...
def args_parser():
    ...
    #                     help="eval our model for synthetic data - the Gen Mat model")
    parser.add_argument('--hex_mat', action='store_true', default=False,
                        help="our hex_mat  that we learned, or the hexagonial lattice matrix")
...
def set_bit_rate(args):
    args.R = args.R * args.lattice_dim
    return args
